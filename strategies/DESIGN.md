...
typography:
  display-mega:
    fontFamily: "'Editorial Serif', 'Times New Roman', serif"
    fontSize: 64px
    fontWeight: 300
    lineHeight: 1.05
    letterSpacing: -1.92px
  display-xl:
    fontFamily: "'Editorial Serif', serif"
    fontSize: 48px
    fontWeight: 300
    lineHeight: 1.08
...
Type pairs **Editorial Serif Light** (custom serif at weight 300) for display with **Inter** for body, navigation, captions. The display weight at 300 is the editorial signature — never bold, never heavy.
...
- Display runs Editorial Serif Light at weight 300 — editorial magazine voice.
...
- **Canvas Deep** (`{colors.canvas-deep}` — #0c0a09): Same as ink — used for the rare dark-mode hero.
...
### Font Family
**Editorial Serif Light** is the licensed display serif at weight 300. **Inter** carries body, navigation, captions, and buttons. Fallback: `'Times New Roman', serif` for Editorial Serif, `sans-serif` for Inter.
...
### Principles
- **Display weight stays at 300.** Editorial Serif Light is the editorial signature. Never bold display copy.
- **Subtle letter-spacing on body.** Inter at +0.15-0.18px tracking — slightly looser than default Inter for a more editorial feel.
- **Negative letter-spacing on display.** Editorial Serif pulls -0.32px to -1.92px tighter on display sizes.

### Note on Font Substitutes
Editorial Serif is licensed. Open-source substitute: **EB Garamond** at weight 300 (slightly more humanist) or **GT Sectra** (closer to Editorial Serif's modernity). Use Inter directly for body.
...
**`top-nav`** — Background `{colors.canvas}`, text `{colors.ink}`, height 64px. Layout: wordmark left, primary horizontal menu, Sign In + "Try free" primary CTA right.
...
- Use Editorial Serif Light at weight 300 for every display headline. Never bold.
...
- Don't drop body Inter to weight 300 to match Editorial Serif — body stays at 400/500 for legibility.
...
6. Editorial Serif 300 for display, Inter 400/500 for body.
7. Gradient orbs scoped to atmospheric decoration.

## Known Gaps

- Editorial Serif is a licensed typeface; EB Garamond / GT Sectra are documented substitutes.
